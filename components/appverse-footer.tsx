...
const defaultContent: FooterContent = {
  tagline: "Experience edits like never before. We craft cinematic visuals for brands and creators.",
  copyright: "© 2025 — Expantra",
}
            ...
            <div className="mx-auto w-full max-w-[320px]">
              <div className="relative rounded-[28px] liquid-glass p-2 shadow-2xl">
                <div className="relative aspect-[9/19] w-full overflow-hidden rounded-2xl bg-black">
                  ...
                  <LazyVideo
                    src="https://ik.imagekit.io/ji2lkjg53/Google%20Notebook%20lm%20-%20tbd.mp4?updatedAt=1759329479028"
          ...
          <div className="grid gap-8 md:grid-cols-[1.2fr_1fr_1fr]">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-1.5">
                <Image src="/icons/expantra logo.png" alt="expantra logo" width={24} height={24} className="h-6 w-6" />
                <span className="text-xl font-semibold text-lime-300">Expantra</span>
              </div>
