      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center py-14 sm:py-20">
          ...
          <h1 className="mt-3 text-center text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
            ...
            <span className="block text-lime-300 drop-shadow-[0_0_20px_rgba(132,204,22,0.35)]">ONLINE SERVICES</span>
            <span className="block">FOR BRANDS & CREATORS</span>
          </h1>
    ...
    <div className="relative rounded-[28px] glass-border bg-neutral-900 p-2">
      <div className="relative aspect-[9/19] w-full overflow-hidden rounded-2xl bg-black">
        <LazyVideo
          src={
            videoSrc ??
            "https://ik.imagekit.io/ji2lkjg53/HTC%20VIVE%20Eagle%20AI-tbd_2.mp4?updatedAt=1757486556918"
          }
